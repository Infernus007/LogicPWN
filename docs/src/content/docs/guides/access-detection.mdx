       ...
       async with AsyncRequestRunner() as runner:
           ...
           for result in results:
               if result.is_vulnerable:
                   print(f"🚨 IDOR Vulnerability Found: {result.endpoint}")
               else:
                   print(f"✅ Secure: {result.endpoint}")
   ```
</Steps>
...
<CardGrid stagger>
<Card title="Test Multiple User Roles" icon="star">
...
<Card title="Use Realistic Test Data" icon="document">
...
<Card title="Test Multiple HTTP Methods" icon="external">
