...
<Card title="Key Features" icon="approve-check">
...
<CardGrid stagger>
<Card title="Use Appropriate Presets" icon="approve-check">
Choose the right vulnerability detection presets for your testing scenario.
</Card>

<Card title="Validate Business Logic" icon="approve-check">
Always validate business logic rules to detect logic flaws.
</Card>

<Card title="Use Secure Regex" icon="star">
