...
<CardGrid>
  ...
  <Card title="Reporting & Compliance" icon="puzzle">
    ...
    <ul>
      ...
      <li><a href="./reporter/indian-compliance">Reporter › Indian Compliance</a></li>
      <li><a href="./reporter/indian-law-enforcement">Reporter › Indian Law Enforcement</a></li>
      <li><a href="./reporter/framework-mapper">Reporter › Framework Mapper</a></li>
      <li><a href="./reporter/indian-integration">Reporter › Indian Integration</a></li>
    </ul>
  </Card>
