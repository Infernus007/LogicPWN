...
description: Indian Cybersecurity Compliance Frameworks for Law Enforcement Reports
...
```python
import logicpwn.core.reporter.indian_compliance
# or
...
This module provides 7 class(es) for reporting & compliance.
:::
