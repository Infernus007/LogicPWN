...
description: API documentation for the Reporter Law Enforcement module in LogicPwn framework
...
API documentation for the `logicpwn.core.reporter.law_enforcement` module.
...
```python
import logicpwn.core.reporter.law_enforcement
# or
from logicpwn.core.reporter.law_enforcement import *
```
