...
description: API documentation for the Reporter Integration module in LogicPwn framework
...
API documentation for the `logicpwn.core.reporter.integration` module.
...
```python
import logicpwn.core.reporter.integration
# or
from logicpwn.core.reporter.integration import *
```
