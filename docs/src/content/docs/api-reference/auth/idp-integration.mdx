---
title: Auth Idp Integration
description: Identity Provider (IdP) Integration for LogicPwn
...
```python
import logicpwn.core.auth.idp_integration
# or
from logicpwn.core.auth.idp_integration import *
```
...
This module provides 8 class(es) for authentication.
:::
...
Initialize a new instance of `BaseIdPProvider`.
