---
title: Validator Validator Models
description: Validation data models and enums for LogicPwn response validation
category: Validation
sidebar:
  order: 68
---
...
```python
import logicpwn.core.validator.validator_models
# or
from logicpwn.core.validator.validator_models import *
```
...
This module provides 8 class(es) for validation.
:::
