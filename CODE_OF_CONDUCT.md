...
As a security testing framework, we have additional ethical responsibilities:

* **Authorized Use Only**: LogicPwn is designed for authorized security testing only
* **Responsible Disclosure**: Report security vulnerabilities through proper channels
* **Privacy Protection**: Respect privacy and confidentiality of all parties
...
[security@logicpwn.org](mailto:security@logicpwn.org).
