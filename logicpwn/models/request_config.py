...
class RequestConfig(BaseModel):
    ...
    data: Optional[Dict[str, Any]] = Field(default=None, description="Form data for POST requests")
    json_data: Optional[Dict[str, Any]] = Field(default=None, description="JSON body for requests")
